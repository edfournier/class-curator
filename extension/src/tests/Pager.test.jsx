...
describe("Pager Component", () => {
    test("calls onLeft when the left button is clicked", () => {
        render(<Pager onLeft={mockOnLeft} onRight={mockOnRight} leftOff={false} rightOff={false} />);
    ...
    test("disables the left button when leftOff is true", () => {
        render(<Pager onLeft={mockOnLeft} onRight={mockOnRight} leftOff={true} rightOff={false} />);
    ...
    test("disables the right button when rightOff is true", () => {
        render(<Pager onLeft={mockOnLeft} onRight={mockOnRight} leftOff={false} rightOff={true} />);
